...
for ind = 1:ninds
    ...
    elseif PARTITION(ind)~=0
        if PARTITION(ind)>0
            ...
            % Yksilˆt, joita ei ole sijoitettu mihink‰‰n koriin.
            arvot = zeros(1,npops);
            for q=1:npops
                osuusTaulu = zeros(1,npops);
                osuusTaulu(q) = 1;
...
% Muokkaa tulokset muotoon, jossa outlier yksilˆt on
% poistettu. Tarkalleen ottaen poistaa ne populaatiot, 
% joissa on v‰hemm‰n kuin 'alaraja':n verran yksilˆit?
...
% vastaa yksilˆn ind alleeli. Eri rivit ovat alleelin alkuper‰frekvenssit
% eri populaatioissa. Jos yksilˆlt?puuttuu jokin alleeli, niin vastaavaan
% kohtaa tulee sarake ykkˆsi?
...
% Palauttaa yksilˆn logml:n, kun oletetaan yksilˆn alkuper‰t
...
% todenn‰kˆisyysmassaa populaatioon j. Mik‰li populaatiossa i ei ole
